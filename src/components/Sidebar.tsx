...
import switchEnvironment from "../services/Env.service";
...
export default function Sidebar(props: SidebarProps) {
  ...
  const [env, setEnv] = useState(switchEnvironment.getEnv);
  ...
  const handleEnvChange = (checked: boolean) => {
    switchEnvironment.setEnv = checked;
    setEnv(checked);
  };
  ...
  useEffect(() => {
    ...
    if (env !== undefined) {
      switchEnvironment.setEnv = env;
    }

    EventChainService.anchoring = anchoring;
  }, [anchoring, env, balance]);
